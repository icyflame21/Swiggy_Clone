    ...
    <div className="foot_text"><p>By clicking on Login, I accept the terms & Conditions & Privacy Policy</p></div>
      ...
      <nav className="navbar">
          ...
          <div className="div1_nav">
              ...
              <div className="location">Bhubaneswar, Odisha, India &nbsp;<img src={Arrow} alt="" className='arrow'/>
              </div>
          </div>
          <div className="div2_nav">
        <p className="search"><img src={Search} alt="" className='search_icon'/>
        Search  </p> 
          </div>
          <div className="div3_nav">
              <p className="offers"><img src={Discount} alt="" className='discount_icon'/>Offers <span className='new'>NEW</span> </p> 
          </div>
          <div className="div4_nav">
              <p className="help"><img src={Help} alt="" className='help_icon'/>Help</p> 
          </div>
          <div className="div5_nav">
              <p className="sign_in" onClick={()=>{setisDrawerRegisterOpen(true)}}><img src={User} alt="" className='user_icon' />Sign In</p> 
          </div>
