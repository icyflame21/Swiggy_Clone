...
function Food_body() { 
  ...
  document.addEventListener('click', function handlerClick(e) {
    if (e.target.innerHTML == "Relevance") {
      e.target.classList.add('active_link')
      if (e.target.innerHTML !== "Relevance") {
        e.target.classList.remove('active_link')
      }
      
    }
    else if (e.target.innerHTML == "Delivery Time") {
      e.target.classList.add('active_link')
    ...
    else if (e.target.innerHTML.includes("Filters")) {
      e.target.classList.add('active_link')
    }
  })
  ...
  const showRestaurants = () => {
    ...
    checkBoxes.forEach(item => {
      ...
      data.cuisines.forEach((e) => {
        array.push(e.toLowerCase().trim())
      })
    })
    const myFoodFiltered = foodItems.filter((array) => {
      result.some((data) => {
        data.item==array.cuisines
      })
    })
    console.log(myFoodFiltered)
    setfoodItems(myFoodFiltered)
  ...
  return (
    ...
    <Box role='presentation' p={6} width='500px'>
          ...
          <input type="checkbox"  id="american" value="american" className="check" />
                <span className="check_Box">&nbsp;American</span>
                <div class="control_indicator"></div>
          </label>
          <label class="control control-checkbox">
          <input type="checkbox"  id="bakery" value="bakery" className="check"/>
          ...
          <label class="control control-checkbox">
          <input type="checkbox"  id="bengali" value="bengali" className="check"/>
                <span className="check_Box">&nbsp;Bengali</span>
                <div class="control_indicator"></div>
          </label>
          <label class="control control-checkbox">
          <input type="checkbox"  id="beverages" value="beverages" className="check"/>
          ...
          <label class="control control-checkbox">
          <input type="checkbox" id="biryani" value="biryani" className="check"/>
                <span className="check_Box">&nbsp;Biryani</span>
                <div class="control_indicator"></div>
          </label>
          <label class="control control-checkbox">
          <input type="checkbox"  id='chinese' value="chinese" className="check"/>
          ...
          <label class="control control-checkbox">
          <input type="checkbox" id='combo' value="combo" className="check"/>
                <span className="check_Box">&nbsp;Combo</span>
                <div class="control_indicator"></div>
          </label>
          <label class="control control-checkbox">
          <input type="checkbox"  id='continental' value="continental" className="check"/>
          ...
          <label class="control control-checkbox">
          <input type="checkbox" id='desserts' value="desserts" className="check"/>
                <span className="check_Box">&nbsp;Desserts</span>
                <div class="control_indicator"></div>
          </label>
          <label class="control control-checkbox">
          <input type="checkbox" id='fast_food' value="fast food" className="check"/>
          ...
          <label class="control control-checkbox">
          <input type="checkbox" id='healthy_food' value="healthy food" className="check"/>
                <span className="check_Box">&nbsp;Healthy Food</span>
                <div class="control_indicator"></div>
          </label>
          <label class="control control-checkbox">
          <input type="checkbox" id='ice_cream' value="ice cream" className="check"/>
          ...
          <label class="control control-checkbox">
          <input type="checkbox" id="indian" value="indian" className="check"/>
          <span className="check_Box">&nbsp;Indian</span>
          <div class="control_indicator"></div>
          </label>
          <label class="control control-checkbox">
          <input type="checkbox" id='italian' value="italian" className="check"/>
          ...
          <label class="control control-checkbox">
          <input type="checkbox" id="sea_food" value="sea food" className="check"/>
                <span className="check_Box">&nbsp;Sea Food</span>
                <div class="control_indicator"></div>
          </label>
          <label class="control control-checkbox">
          <input type="checkbox" id="snacks" value="snacks" className="check"/>
          ...
          <label class="control control-checkbox">
          <input type="checkbox" id="north_indian" value="north indian" className="check"/>
                <span className="check_Box">&nbsp;North Indian</span>
                <div class="control_indicator"></div>
          </label>
          <label class="control control-checkbox">
          <input type="checkbox" id="oriya" value="oriya" className="check"/>
          ...
          <label class="control control-checkbox">
          <input type="checkbox" id="pastas" value="pastas" className="check"/>
                <span className="check_Box">&nbsp;Pastas</span>
                <div class="control_indicator"></div>
          </label>
          <label class="control control-checkbox">
          <input type="checkbox" id="pizzas" value="pizzas" className="check"/>
          ...
          <label class="control control-checkbox">
          <input type="checkbox" id="punjabi" value="punjabi" className="check"/>
                <span className="check_Box">&nbsp;Punjabi</span>
                <div class="control_indicator"></div>
          </label>
          <label class="control control-checkbox">
          <input type="checkbox" id="salads" value="salads" className="check"/>
          ...
          <label class="control control-checkbox">
          <input type="checkbox" id="south_indian" value="south indian" className="check"/>
                <span className="check_Box">&nbsp;South Indian</span>
                <div class="control_indicator"></div>
          </label>
          <label class="control control-checkbox">
          <input type="checkbox" id="street_food" value="street food" className="check"/>
          ...
          <label class="control control-checkbox">
          <input type="checkbox" id="sweets" value="sweets" className="check"/>
                <span className="check_Box">&nbsp;Sweets</span>
                <div class="control_indicator"></div>
          </label>
          <label class="control control-checkbox">
          <input type="checkbox" id="tandoor" value="tandoor" className="check"/>
          ...
          <label class="control control-checkbox">
          <input type="checkbox" id="thai" value="thai" className="check"/>
                <span className="check_Box">&nbsp;Thai</span>
                <div class="control_indicator"></div>
          </label>
          <label class="control control-checkbox">
          <input type="checkbox" id="thalis" value="thalis" className="check"/>
                <span className="check_Box">&nbsp;Thalis</span>
                <div class="control_indicator"></div>
          </label>
            </div>
          </div>
          <button className='clear_btn' onClick={clear_btn}>CLEAR</button>
          <button className='show_food_btn' onClick={showRestaurants}>SHOW RESTAURANTS</button>
    </Box>
    </Drawer>
    <Wrapper>
      ...
      <div className="container_navbar">
        <div className="nav_food">
          <h2 className='restaurantNum'>{ data.length*4} restaurants</h2>
          <div className="action_buttons" onClick={sortingLinks}>
            ...
            <p className="filter_link" onClick={() => { setisDraweropen(true) }}>Filters&nbsp;<i class="fa fa-filter"></i></p>
          </div>
        </div>
      </div>
      <div className="container_card">
        {foodItems.map((food_data) => (
          <>
            <div className="food_card" key={food_data.id}  onClick={()=>localStorage.setItem("foodId",JSON.stringify(foodItems[+food_data.id]))}>
              {food_data.promoted && <div className="promoted" id='is_promote'>PROMOTED</div>}
            <img src={food_data.img_url} alt="Food_Image" className='food_image'></img>
              <h4 className='Header_card'>{ food_data.name}</h4>
              <p className='para_card'>{ food_data.cuisines.join(",")}</p>
            <div className="food_details">
                <div className="rating" style={{ backgroundColor: food_data.rating<4?"#db7c38":"#48c479"}} ><i class='far fa-star'></i>&nbsp;{food_data.rating}</div>
                <div className="average_time">{food_data.average_time }&nbsp;MINS</div>
                <div className="average_price">&#8377;{food_data.average_cost } FOR TWO</div>
            </div>
              <div className="footer"><img src={Discount} alt="" className='discount_icon' />{Math.floor(Math.random() * 90+10 )}% off | use TRYNEW</div>
            </div>
            </>
        ))}
